...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <div class = "w-100">
                <div class ="position-relative w-100 overflow-hidden" style = "height:1000px">
                    ...
                    <div class ="position-absolute start-50 translate-middle" style = "z-index:1020; top:30%;">
                        <div class ="d-flex flex-column align-items-center justify-content-between">
                            ...
                            <p class ="text-light display-6 text-center fw-light mb-3">
                                Something went wrong, please head back to home page
                            </p>
