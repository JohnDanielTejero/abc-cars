            ...
            <div class = "w-100" style = "padding-top:6.5rem;">
              <div class = "container">
                  <div class = "my-5">   
                        ...
                        <div class = "card">
                            <div class ="card-body">
                                 <sf:form class = "row g-3 p-2 px-3" enctype = "multipart/form-data" modelAttribute = "carForm" method = "POST" action = "/admin/updateCar?${_csrf.parameterName}=${_csrf.token}">
                                        ...
                                        <div class = "col-12 d-flex align-items-center justify-content-center">
                                            <div class = "overflow-hidden border rounded-3" style = "height:30rem; width:50rem;">
                                                <c:if test = "${carForm.getImagePath() ne null}">
                                                    <img src = '/carPicture/${carForm.getImagePath()}' class ="w-100 h-100"/>
                                                </c:if>
