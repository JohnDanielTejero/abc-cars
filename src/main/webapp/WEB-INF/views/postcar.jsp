    ...
    <body>
        ...
        <main>
            <div class = "w-100" style = "padding-top:6.5rem;">
              <div class = "container">
                  <div class = "my-5">   
                        <h1 class = "fw-bolder">Sell Car</h1>
                        <div class = "card">
                            <div class ="card-body">
                                <sf:form class = "row g-3 p-2 px-3" enctype = "multipart/form-data" modelAttribute = "carForm" method = "POST" action = "/newcarpost?${_csrf.parameterName}=${_csrf.token}">
